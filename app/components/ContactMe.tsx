...
function ContactMe() {
  return (
    <div className='bg-green-800/50 m-3 p-3 rounded-lg shadow-lg backdrop-blur-md ' style={{boxShadow:'0 0 20px #2a593e'}} id='contact'>
        <h1 className='text-2xl text-center'>Contact Me</h1>        
        <div className="flex flex-row justify-between mt-3 [&_*]:hover:scale-110 [&_*]:hover:text-green-500 px-20">             
